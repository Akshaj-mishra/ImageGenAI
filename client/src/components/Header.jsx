...
export const Header = () => {
  return (
    <div className='flex flex-col justify-center items-center text-center my-20'>
        ...
        <p className='mt-20 my-24 text-4xl text-center'>Unleash your creativity with Ai. Turn your wild imagination into visual art in seconds - just type and watch the magic happen. </p>
    </div>
  )
}
